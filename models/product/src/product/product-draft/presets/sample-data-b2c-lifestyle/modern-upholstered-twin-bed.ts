...
const modernUpholsteredTwinBed = (): TBuilder<TProductDraft> =>
  ProductDraft.presets
    ...
    .masterVariant(
      ProductVariantDraft.presets.sampleDataB2CLifestyle.modernUpholsteredTwinBed01()
    )
    .variants([
      ProductVariantDraft.presets.sampleDataB2CLifestyle.modernUpholsteredTwinBed02(),
      ProductVariantDraft.presets.sampleDataB2CLifestyle.modernUpholsteredTwinBed03(),
      ProductVariantDraft.presets.sampleDataB2CLifestyle.modernUpholsteredTwinBed04(),
    ])
    .categories([
