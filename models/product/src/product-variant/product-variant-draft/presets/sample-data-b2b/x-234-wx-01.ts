...
const x234Wx01 = (): TBuilder<TProductVariantDraft> =>
  ProductVariantDraft.presets
    ...
    .images([
      Image.ImageDraft.presets
        .empty()
        .url(
          'https://storage.googleapis.com/merchant-center-europe/sample-data/b2bstore/x234-wx-2015.webp'
        )
