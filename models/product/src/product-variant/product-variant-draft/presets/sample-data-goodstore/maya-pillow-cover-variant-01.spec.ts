...
import mayaPillowCoverVariant01 from './maya-pillow-cover-variant-01';
describe(`with mayaPillowCoverVariant01 preset`, () => {
  it('should return a sample mayaPillowCoverVariant01 product preset', () => {
    const mayaPillowCoverVariant01Preset =
      mayaPillowCoverVariant01().build<TProductVariantDraft>();
    expect(mayaPillowCoverVariant01Preset).toMatchInlineSnapshot(`
      {
        "assets": undefined,
        "attributes": [
          {
