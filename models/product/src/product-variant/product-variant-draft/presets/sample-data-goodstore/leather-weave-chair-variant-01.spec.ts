...
import leatherWeaveChairVariant01 from './leather-weave-chair-variant-01';
describe(`with leatherWeaveChairVariant01 preset`, () => {
  it('should return a sample leatherWeaveChairVariant01 product preset', () => {
    const leatherWeaveChairVariant01Preset =
      leatherWeaveChairVariant01().build<TProductVariantDraft>();
    expect(leatherWeaveChairVariant01Preset).toMatchInlineSnapshot(`
      {
        "assets": undefined,
        "attributes": [
          {
