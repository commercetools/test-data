...
import largeCeramicPlateVariant02 from './large-ceramic-plate-variant-02';
describe(`with largeCeramicPlateVariant02 preset`, () => {
  it('should return a sample largeCeramicPlateVariant02 product preset', () => {
    const largeCeramicPlateVariant02Preset =
      largeCeramicPlateVariant02().build<TProductVariantDraft>();
    expect(largeCeramicPlateVariant02Preset).toMatchInlineSnapshot(`
      {
        "assets": undefined,
        "attributes": [
          {
