...
import cottonSilkBedsheetVariant05 from './cotton-silk-bedsheet-variant-05';
describe(`with cottonSilkBedsheetVariant05 preset`, () => {
  it('should return a sample cottonSilkBedsheetVariant05 product preset', () => {
    const cottonSilkBedsheetVariant05Preset =
      cottonSilkBedsheetVariant05().build<TProductVariantDraft>();
    expect(cottonSilkBedsheetVariant05Preset).toMatchInlineSnapshot(`
      {
        "assets": undefined,
        "attributes": [
          {
