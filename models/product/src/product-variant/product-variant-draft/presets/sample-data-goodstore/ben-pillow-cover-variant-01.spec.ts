...
import benPillowCoverVariant01 from './ben-pillow-cover-variant-01';
describe(`with benPillowCoverVariant01 preset`, () => {
  it('should return a sample benPillowCoverVariant01 product preset', () => {
    const benPillowCoverVariant01Preset =
      benPillowCoverVariant01().build<TProductVariantDraft>();
    expect(benPillowCoverVariant01Preset).toMatchInlineSnapshot(`
      {
        "assets": undefined,
        "attributes": [
          {
        ...
        "images": [
          {
            ...
            "label": undefined,
            "url": "https://2eca75039cf911b9bbe5-79bfd3e36f011d786971804e873c4354.ssl.cf3.rackcdn.com/Ben%20Pillow%20Cover-EQp6ZHZK.jpeg",
          },
        ],
        "key": undefined,
        "prices": [
