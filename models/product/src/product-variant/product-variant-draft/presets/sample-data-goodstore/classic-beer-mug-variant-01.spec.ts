...
import classicBeerMugVariant01 from './classic-beer-mug-variant-01';
describe(`with classicBeerMugVariant01 preset`, () => {
  it('should return a sample classicBeerMugVariant01 product preset', () => {
    const classicBeerMugVariant01Preset =
      classicBeerMugVariant01().build<TProductVariantDraft>();
    expect(classicBeerMugVariant01Preset).toMatchInlineSnapshot(`
      {
        "assets": undefined,
        "attributes": [
          {
