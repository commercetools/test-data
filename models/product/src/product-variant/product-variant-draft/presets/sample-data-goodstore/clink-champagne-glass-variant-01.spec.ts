...
import clinkChampagneGlassVariant01 from './clink-champagne-glass-variant-01';
describe(`with clinkChampagneGlassVariant01 preset`, () => {
  it('should return a sample clinkChampagneGlassVariant01 product preset', () => {
    const clinkChampagneGlassVariant01Preset =
      clinkChampagneGlassVariant01().build<TProductVariantDraft>();
    expect(clinkChampagneGlassVariant01Preset).toMatchInlineSnapshot(`
      {
        "assets": undefined,
        "attributes": [
          {
        ...
        "images": [
          {
            ...
            "label": undefined,
            "url": "https://2eca75039cf911b9bbe5-79bfd3e36f011d786971804e873c4354.ssl.cf3.rackcdn.com/Clink%20Champagne%20Glas-HadYHGa4.jpeg",
          },
        ],
        "key": undefined,
        "prices": [
