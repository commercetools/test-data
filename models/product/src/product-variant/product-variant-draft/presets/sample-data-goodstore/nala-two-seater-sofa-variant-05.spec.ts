...
import nalaTwoSeaterSofaVariant05 from './nala-two-seater-sofa-variant-05';
describe(`with nalaTwoSeaterSofaVariant05 preset`, () => {
  it('should return a sample nalaTwoSeaterSofaVariant05 product preset', () => {
    const nalaTwoSeaterSofaVariant05Preset =
      nalaTwoSeaterSofaVariant05().build<TProductVariantDraft>();
    expect(nalaTwoSeaterSofaVariant05Preset).toMatchInlineSnapshot(`
      {
        "assets": undefined,
        "attributes": [
          {
