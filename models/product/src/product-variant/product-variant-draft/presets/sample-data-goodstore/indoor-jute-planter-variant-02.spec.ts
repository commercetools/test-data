...
import indoorJutePlanterVariant02 from './indoor-jute-planter-variant-02';
describe(`with indoorJutePlanterVariant02 preset`, () => {
  it('should return a sample indoorJutePlanterVariant02 product preset', () => {
    const indoorJutePlanterVariant02Preset =
      indoorJutePlanterVariant02().build<TProductVariantDraft>();
    expect(indoorJutePlanterVariant02Preset).toMatchInlineSnapshot(`
      {
        "assets": undefined,
        "attributes": [
          {
