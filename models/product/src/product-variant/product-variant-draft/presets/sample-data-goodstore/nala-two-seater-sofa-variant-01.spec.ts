...
import nalaTwoSeaterSofaVariant01 from './nala-two-seater-sofa-variant-01';
describe(`with nalaTwoSeaterSofaVariant01 preset`, () => {
  it('should return a sample nalaTwoSeaterSofaVariant01 product preset', () => {
    const nalaTwoSeaterSofaVariant01Preset =
      nalaTwoSeaterSofaVariant01().build<TProductVariantDraft>();
    expect(nalaTwoSeaterSofaVariant01Preset).toMatchInlineSnapshot(`
      {
        "assets": undefined,
        "attributes": [
          {
