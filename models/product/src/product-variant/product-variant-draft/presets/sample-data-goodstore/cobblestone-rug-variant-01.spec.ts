...
import cobblestoneRugVariant01 from './cobblestone-rug-variant-01';
describe(`with cobblestoneRugVariant01 preset`, () => {
  it('should return a sample cobblestoneRugVariant01 product preset', () => {
    const cobblestoneRugVariant01Preset =
      cobblestoneRugVariant01().build<TProductVariantDraft>();
    expect(cobblestoneRugVariant01Preset).toMatchInlineSnapshot(`
      {
        "assets": undefined,
        "attributes": [
          {
