...
import cottonSilkBedsheetVariant08 from './cotton-silk-bedsheet-variant-08';
describe(`with cottonSilkBedsheetVariant08 preset`, () => {
  it('should return a sample cottonSilkBedsheetVariant08 product preset', () => {
    const cottonSilkBedsheetVariant08Preset =
      cottonSilkBedsheetVariant08().build<TProductVariantDraft>();
    expect(cottonSilkBedsheetVariant08Preset).toMatchInlineSnapshot(`
      {
        "assets": undefined,
        "attributes": [
          {
