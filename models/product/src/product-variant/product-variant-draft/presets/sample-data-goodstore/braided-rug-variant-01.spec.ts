...
import braidedRugVariant01 from './braided-rug-variant-01';
describe(`with braidedRugVariant01 preset`, () => {
  it('should return a sample braidedRugVariant01 product preset', () => {
    const braidedRugVariant01Preset =
      braidedRugVariant01().build<TProductVariantDraft>();
    expect(braidedRugVariant01Preset).toMatchInlineSnapshot(`
      {
        "assets": undefined,
        "attributes": [
          {
