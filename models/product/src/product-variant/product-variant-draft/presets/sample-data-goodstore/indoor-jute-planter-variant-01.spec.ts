...
import indoorJutePlanterVariant01 from './indoor-jute-planter-variant-01';
describe(`with indoorJutePlanterVariant01 preset`, () => {
  it('should return a sample indoorJutePlanterVariant01 product preset', () => {
    const indoorJutePlanterVariant01Preset =
      indoorJutePlanterVariant01().build<TProductVariantDraft>();
    expect(indoorJutePlanterVariant01Preset).toMatchInlineSnapshot(`
      {
        "assets": undefined,
        "attributes": [
          {
