...
import doubleWalledEspressoGlassVariant01 from './double-walled-espresso-glass-variant-01';
describe(`with doubleWalledEspressoGlassVariant01 preset`, () => {
  it('should return a sample doubleWalledEspressoGlassVariant01 product preset', () => {
    const doubleWalledEspressoGlassVariant01Preset =
      doubleWalledEspressoGlassVariant01().build<TProductVariantDraft>();
    expect(doubleWalledEspressoGlassVariant01Preset).toMatchInlineSnapshot(`
      {
        "assets": undefined,
        "attributes": [
          {
