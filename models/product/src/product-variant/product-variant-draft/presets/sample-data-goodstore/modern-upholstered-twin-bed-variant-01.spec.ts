...
import modernUpholsteredTwinBedVariant01 from './modern-upholstered-twin-bed-variant-01';
describe(`with modernUpholsteredTwinBedVariant01 preset`, () => {
  it('should return a sample modernUpholsteredTwinBedVariant01 product preset', () => {
    const modernUpholsteredTwinBedVariant01Preset =
      modernUpholsteredTwinBedVariant01().build<TProductVariantDraft>();
    expect(modernUpholsteredTwinBedVariant01Preset).toMatchInlineSnapshot(`
      {
        "assets": undefined,
        "attributes": [
          {
