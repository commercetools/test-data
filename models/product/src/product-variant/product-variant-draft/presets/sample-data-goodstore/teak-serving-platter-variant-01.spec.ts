...
import teakServingPlatterVariant01 from './teak-serving-platter-variant-01';
describe(`with teakServingPlatterVariant01 preset`, () => {
  it('should return a sample teakServingPlatterVariant01 product preset', () => {
    const teakServingPlatterVariant01Preset =
      teakServingPlatterVariant01().build<TProductVariantDraft>();
    expect(teakServingPlatterVariant01Preset).toMatchInlineSnapshot(`
      {
        "assets": undefined,
        "attributes": [
          {
