...
const leahArmchair01 = (): TProductVariantDraftBuilder =>
  ProductVariantDraft.presets
    ...
    .attributes([
      ...
      AttributeDraft.random()
        .name('finish')
        .value({ 'en-GB': '#E9C55A', 'en-US': '#E9C55A', 'de-DE': '#E9C55A' }),
    ]);
