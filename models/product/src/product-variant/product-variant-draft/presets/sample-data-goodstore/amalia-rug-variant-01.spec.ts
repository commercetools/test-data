...
import amaliaRugVariant01 from './amalia-rug-variant-01';
describe(`with amaliaRugVariant01 preset`, () => {
  it('should return a sample amaliaRugVariant01 product preset', () => {
    const amaliaRugVariant01Preset =
      amaliaRugVariant01().build<TProductVariantDraft>();
    expect(amaliaRugVariant01Preset).toMatchInlineSnapshot(`
      {
        "assets": undefined,
        "attributes": [
          {
