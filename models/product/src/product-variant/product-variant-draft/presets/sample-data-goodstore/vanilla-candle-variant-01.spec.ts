...
import vanillaCandleVariant01 from './vanilla-candle-variant-01';
describe(`with vanillaCandleVariant01 preset`, () => {
  it('should return a sample vanillaCandleVariant01 product preset', () => {
    const vanillaCandleVariant01Preset =
      vanillaCandleVariant01().build<TProductVariantDraft>();
    expect(vanillaCandleVariant01Preset).toMatchInlineSnapshot(`
      {
        "assets": undefined,
        "attributes": [
          {
