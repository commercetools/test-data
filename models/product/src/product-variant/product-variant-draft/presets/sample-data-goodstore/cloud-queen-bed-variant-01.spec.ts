...
import cloudQueenBedVariant01 from './cloud-queen-bed-variant-01';
describe(`with cloudQueenBedVariant01 preset`, () => {
  it('should return a sample cloudQueenBedVariant01 product preset', () => {
    const cloudQueenBedVariant01Preset =
      cloudQueenBedVariant01().build<TProductVariantDraft>();
    expect(cloudQueenBedVariant01Preset).toMatchInlineSnapshot(`
      {
        "assets": undefined,
        "attributes": [
          {
