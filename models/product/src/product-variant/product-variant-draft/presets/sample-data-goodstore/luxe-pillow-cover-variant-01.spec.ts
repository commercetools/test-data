...
import luxePillowCoverVariant01 from './luxe-pillow-cover-variant-01';
describe(`with luxePillowCoverVariant01 preset`, () => {
  it('should return a sample luxePillowCoverVariant01 product preset', () => {
    const luxePillowCoverVariant01Preset =
      luxePillowCoverVariant01().build<TProductVariantDraft>();
    expect(luxePillowCoverVariant01Preset).toMatchInlineSnapshot(`
      {
        "assets": undefined,
        "attributes": [
          {
