...
import ashenRugVariant01 from './ashen-rug-variant-01';
describe(`with ashenRugVariant01 preset`, () => {
  it('should return a sample ashenRugVariant01 product preset', () => {
    const ashenRugVariant01Preset =
      ashenRugVariant01().build<TProductVariantDraft>();
    expect(ashenRugVariant01Preset).toMatchInlineSnapshot(`
      {
        "assets": undefined,
        "attributes": [
          {
