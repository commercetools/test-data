...
import classicChampagneGlassesVariant01 from './classic-champagne-glasses-variant-01';
describe(`with classicChampagneGlassesVariant01 preset`, () => {
  it('should return a sample classicChampagneGlassesVariant01 product preset', () => {
    const classicChampagneGlassesVariant01Preset =
      classicChampagneGlassesVariant01().build<TProductVariantDraft>();
    expect(classicChampagneGlassesVariant01Preset).toMatchInlineSnapshot(`
      {
        "assets": undefined,
        "attributes": [
          {
