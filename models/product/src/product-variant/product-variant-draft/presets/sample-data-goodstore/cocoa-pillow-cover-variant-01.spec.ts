...
import cocoaPillowCoverVariant01 from './cocoa-pillow-cover-variant-01';
describe(`with cocoaPillowCoverVariant01 preset`, () => {
  it('should return a sample cocoaPillowCoverVariant01 product preset', () => {
    const cocoaPillowCoverVariant01Preset =
      cocoaPillowCoverVariant01().build<TProductVariantDraft>();
    expect(cocoaPillowCoverVariant01Preset).toMatchInlineSnapshot(`
      {
        "assets": undefined,
        "attributes": [
          {
