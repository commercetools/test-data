...
import comfortCoffeeMugVariant01 from './comfort-coffee-mug-variant-01';
describe(`with comfortCoffeeMugVariant01 preset`, () => {
  it('should return a sample comfortCoffeeMugVariant01 product preset', () => {
    const comfortCoffeeMugVariant01Preset =
      comfortCoffeeMugVariant01().build<TProductVariantDraft>();
    expect(comfortCoffeeMugVariant01Preset).toMatchInlineSnapshot(`
      {
        "assets": undefined,
        "attributes": [
          {
