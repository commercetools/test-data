...
import fawnArmchairVariant01 from './fawn-armchair-variant-01';
describe(`with fawnArmchairVariant01 preset`, () => {
  it('should return a sample fawnArmchairVariant01 product preset', () => {
    const fawnArmchairVariant01Preset =
      fawnArmchairVariant01().build<TProductVariantDraft>();
    expect(fawnArmchairVariant01Preset).toMatchInlineSnapshot(`
      {
        "assets": undefined,
        "attributes": [
          {
