...
import meadowRugVariant01 from './meadow-rug-variant-01';
describe(`with meadowRugVariant01 preset`, () => {
  it('should return a sample meadowRugVariant01 product preset', () => {
    const meadowRugVariant01Preset =
      meadowRugVariant01().build<TProductVariantDraft>();
    expect(meadowRugVariant01Preset).toMatchInlineSnapshot(`
      {
        "assets": undefined,
        "attributes": [
          {
