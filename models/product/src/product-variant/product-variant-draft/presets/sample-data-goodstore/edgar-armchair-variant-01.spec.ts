...
import edgarArmchairVariant01 from './edgar-armchair-variant-01';
describe(`with edgarArmchairVariant01 preset`, () => {
  it('should return a sample edgarArmchairVariant01 product preset', () => {
    const edgarArmchairVariant01Preset =
      edgarArmchairVariant01().build<TProductVariantDraft>();
    expect(edgarArmchairVariant01Preset).toMatchInlineSnapshot(`
      {
        "assets": undefined,
        "attributes": [
          {
