...
import tanQueenBedVariant01 from './tan-queen-bed-variant-01';
describe(`with tanQueenBedVariant01 preset`, () => {
  it('should return a sample tanQueenBedVariant01 product preset', () => {
    const tanQueenBedVariant01Preset =
      tanQueenBedVariant01().build<TProductVariantDraft>();
    expect(tanQueenBedVariant01Preset).toMatchInlineSnapshot(`
      {
        "assets": undefined,
        "attributes": [
          {
