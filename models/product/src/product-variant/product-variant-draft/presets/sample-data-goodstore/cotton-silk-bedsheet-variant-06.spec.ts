...
import cottonSilkBedsheetVariant06 from './cotton-silk-bedsheet-variant-06';
describe(`with cottonSilkBedsheetVariant06 preset`, () => {
  it('should return a sample cottonSilkBedsheetVariant06 product preset', () => {
    const cottonSilkBedsheetVariant06Preset =
      cottonSilkBedsheetVariant06().build<TProductVariantDraft>();
    expect(cottonSilkBedsheetVariant06Preset).toMatchInlineSnapshot(`
      {
        "assets": undefined,
        "attributes": [
          {
