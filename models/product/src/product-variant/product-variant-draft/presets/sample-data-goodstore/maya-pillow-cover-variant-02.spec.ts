...
import mayaPillowCoverVariant02 from './maya-pillow-cover-variant-02';
describe(`with mayaPillowCoverVariant02 preset`, () => {
  it('should return a sample mayaPillowCoverVariant02 product preset', () => {
    const mayaPillowCoverVariant02Preset =
      mayaPillowCoverVariant02().build<TProductVariantDraft>();
    expect(mayaPillowCoverVariant02Preset).toMatchInlineSnapshot(`
      {
        "assets": undefined,
        "attributes": [
          {
        ...
        "images": [
          {
            ...
            "label": undefined,
            "url": "https://2eca75039cf911b9bbe5-79bfd3e36f011d786971804e873c4354.ssl.cf3.rackcdn.com/Sanna%20Pillow%20Cover-SSjlYrzF.jpeg",
          },
        ],
        "key": undefined,
        "prices": [
