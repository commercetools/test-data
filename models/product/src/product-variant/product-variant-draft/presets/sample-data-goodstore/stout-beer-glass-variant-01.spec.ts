...
import stoutBeerGlassVariant01 from './stout-beer-glass-variant-01';
describe(`with stoutBeerGlassVariant01 preset`, () => {
  it('should return a sample stoutBeerGlassVariant01 product preset', () => {
    const stoutBeerGlassVariant01Preset =
      stoutBeerGlassVariant01().build<TProductVariantDraft>();
    expect(stoutBeerGlassVariant01Preset).toMatchInlineSnapshot(`
      {
        "assets": undefined,
        "attributes": [
          {
