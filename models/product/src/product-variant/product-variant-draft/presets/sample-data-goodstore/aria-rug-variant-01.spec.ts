...
import ariaRugVariant01 from './aria-rug-variant-01';
describe(`with ariaRugVariant01 preset`, () => {
  it('should return a sample ariaRugVariant01 product preset', () => {
    const ariaRugVariant01Preset =
      ariaRugVariant01().build<TProductVariantDraft>();
    expect(ariaRugVariant01Preset).toMatchInlineSnapshot(`
      {
        "assets": undefined,
        "attributes": [
          {
