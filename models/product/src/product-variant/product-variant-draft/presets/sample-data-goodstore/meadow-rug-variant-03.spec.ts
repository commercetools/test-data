...
import meadowRugVariant03 from './meadow-rug-variant-03';
describe(`with meadowRugVariant03 preset`, () => {
  it('should return a sample meadowRugVariant03 product preset', () => {
    const meadowRugVariant03Preset =
      meadowRugVariant03().build<TProductVariantDraft>();
    expect(meadowRugVariant03Preset).toMatchInlineSnapshot(`
      {
        "assets": undefined,
        "attributes": [
          {
