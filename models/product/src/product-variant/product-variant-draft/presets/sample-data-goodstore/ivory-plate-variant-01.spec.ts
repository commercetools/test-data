...
import ivoryPlateVariant01 from './ivory-plate-variant-01';
describe(`with ivoryPlateVariant01 preset`, () => {
  it('should return a sample ivoryPlateVariant01 product preset', () => {
    const ivoryPlateVariant01Preset =
      ivoryPlateVariant01().build<TProductVariantDraft>();
    expect(ivoryPlateVariant01Preset).toMatchInlineSnapshot(`
      {
        "assets": undefined,
        "attributes": [
          {
