...
import geometricPillowCaseVariant01 from './geometric-pillow-case-variant-01';
describe(`with geometricPillowCaseVariant01 preset`, () => {
  it('should return a sample geometricPillowCaseVariant01 product preset', () => {
    const geometricPillowCaseVariant01Preset =
      geometricPillowCaseVariant01().build<TProductVariantDraft>();
    expect(geometricPillowCaseVariant01Preset).toMatchInlineSnapshot(`
      {
        "assets": undefined,
        "attributes": [
          {
