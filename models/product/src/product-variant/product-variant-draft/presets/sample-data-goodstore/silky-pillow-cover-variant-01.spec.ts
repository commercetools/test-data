...
import silkyPillowCoverVariant01 from './silky-pillow-cover-variant-01';
describe(`with silkyPillowCoverVariant01 preset`, () => {
  it('should return a sample silkyPillowCoverVariant01 product preset', () => {
    const silkyPillowCoverVariant01Preset =
      silkyPillowCoverVariant01().build<TProductVariantDraft>();
    expect(silkyPillowCoverVariant01Preset).toMatchInlineSnapshot(`
      {
        "assets": undefined,
        "attributes": [
          {
