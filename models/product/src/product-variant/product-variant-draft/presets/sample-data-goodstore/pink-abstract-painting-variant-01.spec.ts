...
import pinkAbstractPaintingVariant01 from './pink-abstract-painting-variant-01';
describe(`with pinkAbstractPaintingVariant01 preset`, () => {
  it('should return a sample pinkAbstractPaintingVariant01 product preset', () => {
    const pinkAbstractPaintingVariant01Preset =
      pinkAbstractPaintingVariant01().build<TProductVariantDraft>();
    expect(pinkAbstractPaintingVariant01Preset).toMatchInlineSnapshot(`
      {
        "assets": undefined,
        "attributes": [
          {
