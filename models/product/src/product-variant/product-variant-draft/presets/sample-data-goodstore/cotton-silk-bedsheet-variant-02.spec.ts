...
import cottonSilkBedsheetVariant02 from './cotton-silk-bedsheet-variant-02';
describe(`with cottonSilkBedsheetVariant02 preset`, () => {
  it('should return a sample cottonSilkBedsheetVariant02 product preset', () => {
    const cottonSilkBedsheetVariant02Preset =
      cottonSilkBedsheetVariant02().build<TProductVariantDraft>();
    expect(cottonSilkBedsheetVariant02Preset).toMatchInlineSnapshot(`
      {
        "assets": undefined,
        "attributes": [
          {
