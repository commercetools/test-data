...
import classicCoffeeCupVariant01 from './classic-coffee-cup-variant-01';
describe(`with classicCoffeeCupVariant01 preset`, () => {
  it('should return a sample classicCoffeeCupVariant01 product preset', () => {
    const classicCoffeeCupVariant01Preset =
      classicCoffeeCupVariant01().build<TProductVariantDraft>();
    expect(classicCoffeeCupVariant01Preset).toMatchInlineSnapshot(`
      {
        "assets": undefined,
        "attributes": [
          {
