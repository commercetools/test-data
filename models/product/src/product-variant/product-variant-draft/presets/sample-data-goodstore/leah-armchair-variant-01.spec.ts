...
import leahArmchairVariant01 from './leah-armchair-variant-01';
describe(`with leahArmchairVariant01 preset`, () => {
  it('should return a sample leahArmchairVariant01 product preset', () => {
    const leahArmchairVariant01Preset =
      leahArmchairVariant01().build<TProductVariantDraft>();
    expect(leahArmchairVariant01Preset).toMatchInlineSnapshot(`
      {
        "assets": undefined,
        "attributes": [
          {
