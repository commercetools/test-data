...
import nalaTwoSeaterSofaVariant02 from './nala-two-seater-sofa-variant-02';
describe(`with nalaTwoSeaterSofaVariant02 preset`, () => {
  it('should return a sample nalaTwoSeaterSofaVariant02 product preset', () => {
    const nalaTwoSeaterSofaVariant02Preset =
      nalaTwoSeaterSofaVariant02().build<TProductVariantDraft>();
    expect(nalaTwoSeaterSofaVariant02Preset).toMatchInlineSnapshot(`
      {
        "assets": undefined,
        "attributes": [
          {
