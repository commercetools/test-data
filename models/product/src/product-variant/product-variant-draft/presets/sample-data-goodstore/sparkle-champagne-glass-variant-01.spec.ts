...
import sparkleChampagneGlassVariant01 from './sparkle-champagne-glass-variant-01';
describe(`with sparkleChampagneGlassVariant01 preset`, () => {
  it('should return a sample sparkleChampagneGlassVariant01 product preset', () => {
    const sparkleChampagneGlassVariant01Preset =
      sparkleChampagneGlassVariant01().build<TProductVariantDraft>();
    expect(sparkleChampagneGlassVariant01Preset).toMatchInlineSnapshot(`
      {
        "assets": undefined,
        "attributes": [
          {
