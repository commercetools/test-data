...
import chiantiWineGlassVariant01 from './chianti-wine-glass-variant-01';
describe(`with chiantiWineGlassVariant01 preset`, () => {
  it('should return a sample chiantiWineGlassVariant01 product preset', () => {
    const chiantiWineGlassVariant01Preset =
      chiantiWineGlassVariant01().build<TProductVariantDraft>();
    expect(chiantiWineGlassVariant01Preset).toMatchInlineSnapshot(`
      {
        "assets": undefined,
        "attributes": [
          {
