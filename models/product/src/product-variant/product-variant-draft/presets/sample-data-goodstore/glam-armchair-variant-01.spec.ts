...
import glamArmchairVariant01 from './glam-armchair-variant-01';
describe(`with glamArmchairVariant01 preset`, () => {
  it('should return a sample glamArmchairVariant01 product preset', () => {
    const glamArmchairVariant01Preset =
      glamArmchairVariant01().build<TProductVariantDraft>();
    expect(glamArmchairVariant01Preset).toMatchInlineSnapshot(`
      {
        "assets": undefined,
        "attributes": [
          {
