...
import brunoChairVariant01 from './bruno-chair-variant-01';
describe(`with brunoChairVariant01 preset`, () => {
  it('should return a sample brunoChairVariant01 product preset', () => {
    const brunoChairVariant01Preset =
      brunoChairVariant01().build<TProductVariantDraft>();
    expect(brunoChairVariant01Preset).toMatchInlineSnapshot(`
      {
        "assets": undefined,
        "attributes": [
          {
