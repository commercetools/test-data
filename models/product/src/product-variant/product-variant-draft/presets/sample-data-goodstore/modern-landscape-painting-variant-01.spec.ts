...
import modernLandscapePaintingVariant01 from './modern-landscape-painting-variant-01';
describe(`with modernLandscapePaintingVariant01 preset`, () => {
  it('should return a sample modernLandscapePaintingVariant01 product preset', () => {
    const modernLandscapePaintingVariant01Preset =
      modernLandscapePaintingVariant01().build<TProductVariantDraft>();
    expect(modernLandscapePaintingVariant01Preset).toMatchInlineSnapshot(`
      {
        "assets": undefined,
        "attributes": [
          {
