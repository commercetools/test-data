...
import abigailLoungeChairVariant01 from './abigail-lounge-chair-variant-01';
describe(`with abigailLoungeChairVariant01 preset`, () => {
  it('should return a sample abigailLoungeChairVariant01 product preset', () => {
    const abigailLoungeChairVariant01Preset =
      abigailLoungeChairVariant01().build<TProductVariantDraft>();
    expect(abigailLoungeChairVariant01Preset).toMatchInlineSnapshot(`
      {
        "assets": undefined,
        "attributes": [
          {
