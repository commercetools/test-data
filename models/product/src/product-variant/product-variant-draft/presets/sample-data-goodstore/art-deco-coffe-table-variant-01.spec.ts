...
import artDecoCoffeTableVariant01 from './art-deco-coffe-table-variant-01';
describe(`with artDecoCoffeTableVariant01 preset`, () => {
  it('should return a sample artDecoCoffeTableVariant01 product preset', () => {
    const artDecoCoffeTableVariant01Preset =
      artDecoCoffeTableVariant01().build<TProductVariantDraft>();
    expect(artDecoCoffeTableVariant01Preset).toMatchInlineSnapshot(`
      {
        "assets": undefined,
        "attributes": [
          {
