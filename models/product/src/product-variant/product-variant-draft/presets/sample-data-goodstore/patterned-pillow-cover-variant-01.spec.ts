...
import patternedPillowCoverVariant01 from './patterned-pillow-cover-variant-01';
describe(`with patternedPillowCoverVariant01 preset`, () => {
  it('should return a sample patternedPillowCoverVariant01 product preset', () => {
    const patternedPillowCoverVariant01Preset =
      patternedPillowCoverVariant01().build<TProductVariantDraft>();
    expect(patternedPillowCoverVariant01Preset).toMatchInlineSnapshot(`
      {
        "assets": undefined,
        "attributes": [
          {
