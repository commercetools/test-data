...
const emeraldVelvetChair01 = (): TProductVariantDraftBuilder =>
  ProductVariantDraft.presets
    ...
    .attributes([
      ...
      AttributeDraft.random().name('colorlabel').value({ 'en-GB': 'Emerald' }),
      AttributeDraft.random().name('color').value({ 'en-GB': '#219A0E' }),
      AttributeDraft.random().name('finishlabel').value({ 'en-GB': 'Gold' }),
      AttributeDraft.random().name('finish').value({ 'en-GB': '#F8EE18' }),
      AttributeDraft.random()
        .name('color-filter')
        .value({
          key: '#00FF00',
