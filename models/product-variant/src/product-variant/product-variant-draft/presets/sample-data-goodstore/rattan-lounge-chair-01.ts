  ...
  ProductVariantDraft.presets
    ...
    .attributes([
      AttributeDraft.random()
        .name('productspec')
        .value({ 'en-GB': '- Includes 2 cushions for seat and backrest' }),
      ...
      AttributeDraft.random().name('color').value({ 'en-GB': '#EDEBE8' }),
      AttributeDraft.random().name('colorlabel').value({ 'en-GB': 'Pearl' }),
      AttributeDraft.random().name('finishlabel').value({ 'en-GB': 'Rattan' }),
      AttributeDraft.random()
        .name('color-filter')
        .value({
          key: '#808080',
      ...
      AttributeDraft.random().name('finish').value({ 'en-GB': '#E0AC58' }),
    ]);
