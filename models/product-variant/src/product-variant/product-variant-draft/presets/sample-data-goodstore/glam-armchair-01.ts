...
const glamArmchair01 = (): TProductVariantDraftBuilder =>
  ProductVariantDraft.presets
    ...
    .attributes([
      ...
      AttributeDraft.random().name('color').value({ 'en-GB': '#FECB69' }),
      AttributeDraft.random().name('colorlabel').value({ 'en-GB': 'Gold' }),
      AttributeDraft.random()
        .name('color-filter')
        .value({
          key: '#FFD700',
      ...
      AttributeDraft.random().name('finish').value({ 'en-GB': '#FFDF7F' }),
