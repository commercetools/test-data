  ...
  ProductVariantDraft.presets
    ...
    .attributes([
      AttributeDraft.random()
        .name('productspec')
        .value({ 'en-GB': '- Leather requires special care' }),
      ...
      AttributeDraft.random().name('color').value({ 'en-GB': '#FFF8ED' }),
      AttributeDraft.random()
        .name('colorlabel')
        .value({ 'en-GB': 'White Leather' }),
      AttributeDraft.random()
        .name('finishlabel')
        .value({ 'en-GB': 'Chestnut' }),
      AttributeDraft.random().name('finish').value({ 'en-GB': '#1B1101' }),
      AttributeDraft.random()
        .name('color-filter')
        .value({
          key: '#F5F5DC',
