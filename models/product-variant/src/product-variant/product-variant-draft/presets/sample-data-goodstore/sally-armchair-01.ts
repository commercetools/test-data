  ...
  ProductVariantDraft.presets
    ...
    .attributes([
      AttributeDraft.random()
        .name('productspec')
        .value({ 'en-GB': '- Comes with matching throw pillow' }),
      ...
      AttributeDraft.random()
        .name('colorlabel')
        .value({ 'en-GB': 'Baby Pink' }),
      AttributeDraft.random().name('color').value({ 'en-GB': '#FFE0E0' }),
      AttributeDraft.random().name('finishlabel').value({ 'en-GB': 'Cedar' }),
      AttributeDraft.random().name('finish').value({ 'en-GB': '#FAE7C6' }),
      AttributeDraft.random()
        .name('color-filter')
        .value({
          key: '#FFC0CB',
