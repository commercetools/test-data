...
- [#726](https://github.com/commercetools/test-data/pull/726) [`3afc6db`](https://github.com/commercetools/test-data/commit/3afc6db3895ecfcef3bb0ba3c12e62ae4e6379dd) Thanks [@CarlosCortizasCT](https://github.com/CarlosCortizasCT)! - Added a new preset called `withAllFields` to the model.
