...
const presets = {
  excavators,
  highCapacityFrontEndLoaders,
  largeBulldozers,
  dumpTrucks,
  highCapacityMotorGraders,
  heavyDutySoilCompactorsRollers,
  heavyDutyConstructionCranes,
  largeDiameterMiningDrills,
  largeHydraulicHammers,
