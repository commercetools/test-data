...
const lifttechSolutionsLtdDeCart2 = (customerId?: string): TCartDraftBuilder =>
  CartDraft.presets
    .empty()
    ...
    .lineItems([
      ...
      LineItemDraft.presets.empty().sku(bbb234Wx03.sku).quantity(1),
    ])
    .shippingMethod(
...
export default lifttechSolutionsLtdDeCart2;
