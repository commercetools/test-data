...
const lucasDuboisCustomer = CustomerDraft.presets.sampleDataB2B
  .lucasDubois()
...
const lucasDubois = (): TAssociateDraftBuilder =>
  AssociateDraft.random()
    .customer(
      KeyReferenceDraft.presets.customer().key(lucasDuboisCustomer.key!)
    )
