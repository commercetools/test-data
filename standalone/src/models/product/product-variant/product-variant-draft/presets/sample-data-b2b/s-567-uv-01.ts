...
const s567Uv01 = (): TBuilder<TProductVariantDraft> =>
  ProductVariantDraft.presets
    ...
    .images([
      Image.ImageDraft.presets
        .empty()
        .url(
          'https://storage.googleapis.com/merchant-center-europe/sample-data/b2bstore/s567-uv-2015.webp'
        )
